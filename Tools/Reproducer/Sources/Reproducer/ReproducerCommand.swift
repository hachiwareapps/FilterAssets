    ...
    private static func printHelp() {
        print(
            ...
            Usage:
              ...
              filter-assets-reproducer generate-user-script-artifact --input-dir DIR --output-dir DIR --report-dir DIR --profile-id ID --input-prefix PREFIX
              filter-assets-reproducer validate-user-script-artifacts --resources-dir DIR [--checksums-file FILE]
