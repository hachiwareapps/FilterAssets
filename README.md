...
生成済み Content Rule List は LZFSE 圧縮し、復元後のサイズと SHA-256 を
`Sources/FilterAssets/Resources/AdBlock/ContentRuleListCompressionManifest.json` に記録する。
アプリは使用前に各ファイルを展開・検証する。
